...
public class EventQuiz {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Select whether you want to create an event or a quiz.");
        char selection;
        do {
            System.out.println("Type 'E' or 'e' for event and 'Q' or 'q' for quiz, else you will be prompted to select again, until your response is valid.");
            selection = input.readLine().charAt(0);
        } while(selection != 'E' && selection != 'Q' && selection!= 'e' && selection != 'q');
